...
//зверніть увагу на можливість використання ``,яка дозволяє додавати в string змінні ${}
   ...
   prevSlide: function() {
       ...
       this.current = next;
	   document.getElementById("button46").addEventListener("click", function(){this.style.backgroundColor = "red";});
	   document.getElementById("button45").addEventListener("mouseover", function(){this.style.backgroundColor = "green";});
   ...
   nextSlide: function(){
       ...
       this.current = next;
	   document.getElementById("button45").addEventListener("click", function(){this.style.backgroundColor = "red";});
		document.getElementById("button46").addEventListener("mouseover", function(){this.style.backgroundColor = "green";});
   },
  indexSlide: function(id){
       let next;
       next = this.id;
